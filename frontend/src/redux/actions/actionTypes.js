...
export const ASSIGN_MACHINE_FAIL = 'ASSIGN_MACHINE_FAIL';

//Free Machine
export const FREE_MACHINE_REQUEST = 'FREE_MACHINE_REQUEST';
export const FREE_MACHINE_SUCCESS = 'FREE_MACHINE_SUCCESS';
export const FREE_MACHINE_FAIL = 'FREE_MACHINE_FAIL';